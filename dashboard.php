    ...
    <main>
      ...
      <section class="bg-light py-20 flex px-4 justify-center items-center">
        <div class="flex flex-col gap-5 max-w-[500px]">
          <h1 class="text-3xl font-bold text-left">New blog</h1>
          <form class="w-full flex flex-col gap-4" method="POST" action="includes/dashboardsub.php" enctype="multipart/form-data">
            ...
            <div>
              ...
              <textarea class="border" name="desc" id="" cols="50" rows="10">
