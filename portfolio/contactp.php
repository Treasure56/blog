...
<div>
    ...
    <section id="contact-section ">
        <div class="container contact-section p-5 py-5">
            <div class="mx-auto col col-md-10 col-lg-8">
                ...
                <div class=" contact">
                    <div class="d-flex justify-content-between">
                        <div class="col-md-8 fs-5 contact-info">
                            ...
                            <p>Email me: <a href="https://www.yourportfolio.com" target="_blank"
                                    class=" text-decoration-none" style="color:#00BCD5;">Example@gmail.com</a></p>
                            ...
                            <p>I'm based in: <a href="/" target="_blank" class="text-decoration-none"
                                    style="color:#00BCD5;">Nigeria</a></p>
                    ...
                    <form action="../includes/contactsub.php" method="post">
                        ...
                        <input type="hidden" name="next" value="portfolio/contactp.php">
                        ...
                        <button type="submit" class="btn text-white" style="background-color:#00BCD5;">Send
                            Messages</button>
